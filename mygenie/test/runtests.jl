...
# !!! Main.UserApp is configured as an alias for Main.Mygenie and you might encounter it in some tests
using Main.Mygenie, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Mygenie tests" begin
  @includetests ARGS
end
